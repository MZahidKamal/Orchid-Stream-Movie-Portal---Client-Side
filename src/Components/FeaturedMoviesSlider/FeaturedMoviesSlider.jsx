...
const FeaturedMoviesSlider = () => {
    ...
    const {movies: featuredMovies} = useMovieLoader({category: 'Featured'});
        ...
        <section className="bg-gradient-to-br from-[#450207] via-[#93040f] to-[#450207] py-16">
            <div className="w-11/12 lg:container mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-2xl md:text-4xl font-bold text-gray-300">Featured Movies</h2>
                    <Link to="/movies/category/featured" className="flex items-center text-gray-300 hover:text-white transition-colors">
